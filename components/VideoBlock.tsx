				...
				<div className="lg:container mx-auto flex flex-col items-center justify-center gap-4 lg:gap-x-4 xl:gap-x-16">
					...
					>
						...
						<div className="flex flex-col">
							...
							>
								<div
									className={`mt-4 lg:mt-2 w-fit mx-auto lg:mx-0 py-4 px-6 text-center cursor-pointer bg-primary-default hover:bg-primary-two transition-all ease-in-out duration-500`}
								>
