				...
				<div className="lg:container mx-auto p-0">
					<div className={title ? "block py-4" : "hidden"}>
						...
						<motion.h3
							...
							whileInView={fadeInUp}
							viewport={{once: true}}
							className="my-2 max-w-3xl leading-snug lg:leading-[3rem] uppercase font-aspektaMain text-primary-default text-center lg:text-left font-semibold text-lg sm:text-xl lg:text-6xl"
						>
							{title}
						</motion.h3>
					</div>
