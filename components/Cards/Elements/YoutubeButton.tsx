...
import {IYoutubeButton} from "@/types/components";
import {initialTwo, fadeIn} from "@/animations/animations";

const YoutubeButton: FC<IYoutubeButton> = ({
	title,
	fullWidth,
	displayYoutubeIcon,
}) => {
	...
	const sgvYoutubeTextColor = "#ffffff";
	...
	return (
		<>
			<motion.button
				...
				className={
					title
						? `group flex items-center justify-center gap-3 w-fit mx-auto lg:mx-0 mt-3 px-6 py-3 text-base text-white uppercase tracking-[0.05rem] font-normal sm:mx-0 bg-primary-three hover:bg-primary-default transition-all ease-in-out duration-500`
						: `hidden`
				}
			>
				<h3>{title}</h3>
