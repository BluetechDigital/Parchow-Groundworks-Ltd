...
const ContentSectorGrid: FC<IContentSectorGrid> = ({
	...
	return (
		<>
			...
			>
				<div className="container m-auto flex flex-col items-center gap-6">
					<motion.div
						initial={initial}
						variants={stagger}
						whileInView="animate"
					...
					>
						<div>
							...
							<motion.h3
								...
								whileInView={fadeInUp}
								viewport={{once: true}}
								className="my-3 max-w-xl mx-auto lg:mx-0 uppercase text-black text-center lg:text-left text-lg sm:text-3xl"
							>
								{title}
							</motion.h3>
						</div>
